...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { title: 'Parents', icon: Heart, path: '/parents', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'STAFF', 'PARENT'] },
  ...
  { title: 'Fees', icon: CreditCard, path: '/fees', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'ACCOUNTANT', 'STUDENT', 'PARENT'] },
